    ...
    <main>
        <section class="page-header page-mtn">
            ...
            <div class="d-flex align-items-baseline">
                ...
                <h1 class="ps-3">Single View</h1>
            </div>

            <h2 class="page-mtn__title mb-2 bg-dark text-light p-2 rounded"> <?php echo h($title); ?></h2>

            <div class="page-grid">

                <div class="page-mtn__images">
                    <div class="page-mtn__main-img mb-2 ">
                ...
                <article class="page-mtn__content rounded-4 shadow ">
                    <div class="d-flex justify-content-between mb-2">
                        <div class="page-mtn__details p-3 pb-0 w-100">
                            <ul class="page-txt-stats p-0 fs-5">
                                <li class=" d-flex border-bottom pb-2">
                    ...
                    <div class="page-mtn__footer p-3 pt-0 d-flex justify-content-between flex-wrap align-items-end gap-4">
