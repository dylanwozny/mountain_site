...
<!-- FINISH INTRO -->
<header class="justify-content-between banner front-about-p d-flex flex-wrap gap-3 mb-7">
  ...
  <?php if (!(isset($_SESSION["x5ghy789soci"]))) { ?>
    <div class="banner__login text-center flex-grow-1 rounded-3 shadow p-4 align-self-start">
  ...
  <div class="jumbotron categories row">
    ...
    <div class="sort-list container ">
      <ul class="d-flex fs-5 p-0 mb-4 text-light gap-1 justify-content-flex-start flex-wrap">
        ...
        <li><a class=" rounded-pill btn btn-dark p-1 d-block no-decoration " href="<?php echo WWW_ROOT . "/" . "index" ?>.php?filter=<?php echo "province" ?>">Alberta</a></li>
        <li><a class=" rounded-pill btn btn-dark p-1 d-block no-decoration " href="<?php echo WWW_ROOT . "/" . "index" ?>.php?filter=<?php echo "volcano" ?>">Volcanoes</a></li>
      </ul>
    </div>
