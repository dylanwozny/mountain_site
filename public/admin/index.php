...
<header class="d-flex align-items-center mb-4">
    <svg class="mb-3" xmlns=" http://www.w3.org/2000/svg" viewBox="0 0 54.894 54.894">
    ...
    <h1 class="ps-2 "><?php echo $page_title ?></h1>
</header>

<section class="admin-new bg-light rounded-4 p-2 ps-3 pe-3  mb-4 shadow-lg d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <p class="fs-4 mb-0 text-capitalize ps-2">New Mountain</p>
    </div>
...
<section class="bg-light rounded-4 shadow-lg">
    <h2 class="p-3 pt-4 pb-0">Current Mountains</h2>
    <div class="p-3 pt-0 pb-0"> <?php pagination_Render($result['count'], $result['current'], $result['name']); ?></div>
    ...
    <div class="pt-0 p-3 pb-2 "> <?php pagination_Render($result['count'], $result['current'], $result['name']); ?></div>
</section>
