        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td class="hover-fill-secondary"><a class="btn btn-secondary" href="<?php echo 'pages/edit.php?mtn_id=' . h(u($mtnId)); ?>"> <svg class="svg-btn me-2" id="Icon_awesome-pencil-alt" viewBox="0 0 25.998 25.999">
